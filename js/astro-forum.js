...
const displayPosts = posts => {
  ...
  // if (phones.length > 9 && showAllPhones == false) {
    ...
    <div>
      <div class="relative">
        ...
        <div id="post-author-active"
          class="w-4 h-4 lg:w-6 lg:h-6 absolute -top-1 lg:-top-2 lg:-right-2 rounded-full ${active}"></div>
      </div>
    </div>
    <!-- Card Right -->
    <div class="flex flex-col gap-3">
      <p class="flex flex-col lg:flex-row gap-3 lg:gap-10 font-medium">
